...
export function User({ user }: { user: User }) {
    return (
        <div
            className={`flex items-center gap-4 py-3 px-2 m-2 rounded-xl ${user.isMe ? "bg-purple-900/30 border-b-1 border-purple-400/50" : ""}`}
        >
            <div className="flex items-center gap-3 min-w-0 flex-1">
                <div className="min-w-0">
                    ...
                    <div className="text-gray-300/80 text-sm truncate">
                        D: {user.downloadTime}
                    </div>
                </div>
