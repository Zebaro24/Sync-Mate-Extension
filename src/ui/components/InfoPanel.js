export default class InfoPanel {
    constructor({playerFrame, playerControlTimeline}) {
    ...
    setUpInformationPanel() {
        ...
        const observer = new MutationObserver(() => {
            const visible = window.getComputedStyle(this.playerControlTimeline).visibility !== 'hidden';
            this.panel.style.visibility = visible ? 'visible' : 'hidden';
        });

        observer.observe(this.playerControlTimeline, {attributes: true, attributeFilter: ['style']});
